...
import { Alfa_Slab_One, Rammetto_One, Oswald, Inter } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${alfaSlabOne.variable} ${rammettoOne.variable} ${oswald.variable} ${inter.variable} h-full`}
    >
