...
const LIST: Entry[] = [
  // ── Resident Evil films ──────────────────────────────────────────────────
  { q: "Resident Evil",                        y: 2002, type: "movie", subgenres: ["Zombie","Sci-Fi Horror","Creature Feature"], score: 55 },
  { q: "Resident Evil: Apocalypse",            y: 2004, type: "movie", subgenres: ["Zombie","Sci-Fi Horror","Creature Feature"], score: 22 },
  { q: "Resident Evil: Extinction",            y: 2007, type: "movie", subgenres: ["Zombie","Sci-Fi Horror","Creature Feature"], score: 25 },
  { q: "Resident Evil: Afterlife",             y: 2010, type: "movie", subgenres: ["Zombie","Sci-Fi Horror","Creature Feature"], score: 22 },
  { q: "Resident Evil: Retribution",           y: 2012, type: "movie", subgenres: ["Zombie","Sci-Fi Horror","Creature Feature"], score: 18 },
  { q: "Resident Evil: The Final Chapter",     y: 2016, type: "movie", subgenres: ["Zombie","Sci-Fi Horror","Creature Feature"], score: 20 },
  { q: "Resident Evil: Welcome to Raccoon City", y: 2021, type: "movie", subgenres: ["Zombie","Sci-Fi Horror","Creature Feature"], score: 32 },
  // ── Resident Evil TV ────────────────────────────────────────────────────
  { q: "Resident Evil",                        y: 2022, type: "tv",    subgenres: ["Zombie","Sci-Fi Horror"],                    score: 28 },
  // ── Silent Hill ─────────────────────────────────────────────────────────
  { q: "Silent Hill",                          y: 2006, type: "movie", subgenres: ["Supernatural","Creature Feature"],           score: 68 },
  { q: "Silent Hill: Revelation",              y: 2012, type: "movie", subgenres: ["Supernatural","Creature Feature"],           score: 22 },
  { q: "Return to Silent Hill",                y: 2026, type: "movie", subgenres: ["Supernatural","Creature Feature"],           score: 28 },
  // ── Other game adaptations ───────────────────────────────────────────────
  { q: "Five Nights at Freddy's",              y: 2023, type: "movie", subgenres: ["Creature Feature","Supernatural"],           score: 52 },
  { q: "Until Dawn",                           y: 2024, type: "movie", subgenres: ["Slasher","Supernatural"],                    score: 52 },
  { q: "Werewolves Within",                    y: 2021, type: "movie", subgenres: ["Werewolf","Comedy Horror"],                  score: 82 },
  { q: "Doom",                                 y: 2005, type: "movie", subgenres: ["Sci-Fi Horror","Creature Feature"],          score: 18 },
];
...
export async function GET(request: NextRequest) {
  ...
  for (let i = 0; i < LIST.length; i++) {
    ...
    if (!existing) {
      const gm = e.type === "movie" ? movieGM : tvGM;
      const td = await searchTMDB(e.q, e.y, e.type, gm);
      if (td) {
