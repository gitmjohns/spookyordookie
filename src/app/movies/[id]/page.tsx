              ...
              <div className="hidden md:block md:w-52 shrink-0">
                <div className="bg-tomb border border-shadow rounded-2xl p-4 space-y-3">
                  <div className="text-center pb-3 border-b border-shadow">
                    ...
                    <div className="font-display text-5xl font-black leading-none mt-1" style={{ color: overallColor }}>
                      {overallScore}
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="text-center">
                      ...
                      <div className="font-display text-xl font-bold" style={{ color: criticColor }}>
                    ...
                    <div className="text-center">
                      ...
                      <div className="font-display text-xl font-bold" style={{ color: fanColor }}>
