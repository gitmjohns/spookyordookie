          ...
          {user ? (
            ...
            <div className="relative overflow-hidden rounded-xl">
              ...
              <div className="absolute inset-0 backdrop-blur-[3px] bg-void/60 rounded-xl flex flex-col items-center justify-center gap-3">
                ...
                <a href={`/auth/login?next=${encodeURIComponent(`/movies/${id}`)}`} className="px-6 py-2 bg-purple-mid hover:bg-purple-light text-ghost text-sm font-medium rounded-xl transition-colors">
                  Sign In
                </a>
              </div>
            </div>
